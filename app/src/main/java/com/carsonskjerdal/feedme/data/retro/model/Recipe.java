package com.carsonskjerdal.feedme.data.retro.model;
...
public class Recipe {
    ...
    /*public static Recipe fromJson(JSONObject jsonObject) {
        ...
        try {
            b.idDrink = jsonObject.getString("idDrink");
            b.strDrink = jsonObject.getString("strDrink");
            b.strCategory = jsonObject.getString("strCategory");
            b.strAlcoholic = jsonObject.getString("strAlcoholic");
